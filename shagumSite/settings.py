"""
Django settings for shagumSite project.
...
#SECRET_KEY = '0&qt2s@igme@k$^$(id#@%8i2lf1=lak)ms*_88k-)(z_^6gvf'
SECRET_KEY = os.environ.get('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = (os.environ.get('DEBUG_VALUE') == 'True')

ALLOWED_HOSTS = ['shagumsite.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'shagumSite.wsgi.application'
...
LOGIN_REDIRECT_URL = "home-notification"
...
AWS_CELERY_S3_REGION_NAME = os.environ.get('AWS_CELERY_S3_REGION_NAME') #'us-east-2'
